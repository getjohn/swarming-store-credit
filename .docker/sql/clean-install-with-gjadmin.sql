...
--
-- Host: localhost    Database: mag_testdata_db
-- ------------------------------------------------------
...
INSERT INTO `admin_passwords` VALUES (2,2,'b658440d8fe9cb8af3035f41460fb2ec4d925b5910873db063c5f115f8da67d8:upCIVrFdZPpOpzcH:2',0,1615462757),(3,2,'0d3af388b3f71311dade721e37e70f6f694767fd5d3a9a40c995a3ad1effaebf:oEVUddQqsx5xFF5SUunc67FmITHirVpS:3_32_2_67108864',0,1616436987);
...
INSERT INTO `admin_user` VALUES (2,'GetJohn','Admin','devtest+blank@getjohn.co.uk','gjadmin','0d3af388b3f71311dade721e37e70f6f694767fd5d3a9a40c995a3ad1effaebf:oEVUddQqsx5xFF5SUunc67FmITHirVpS:3_32_2_67108864','2021-03-11 11:39:17','2021-03-22 18:16:27','2021-03-22 18:16:27',2,0,1,'null',NULL,NULL,'en_US',0,NULL,NULL,NULL);
...
INSERT INTO `admin_user_session` VALUES (1,'gq4mav9q5on1odomif0t2369ud',2,1,'2021-03-11 11:40:34','2021-03-11 11:50:12','94.13.145.45'),(2,'mn52753ob8m65b452f62uae1og',2,0,'2021-03-22 18:16:27','2021-03-22 18:17:16','2a02:c7f:a6a1:e');
...
INSERT INTO `adminnotification_inbox` VALUES (1,4,'2021-02-11 14:37:42','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0),(2,4,'2021-02-22 23:52:27','Quarterly Business Planning - reach out to us today to get your free site assessment.','Would you like a free site assessment? Our best-in-breed commerce solution gives your business unmatched agility and scalability. It&#039;s time to experience limitless eCommerce with no comprises. Learn more: https://bit.ly/3lcgILt','https://bit.ly/3lcgILt',0,0);
...
--
-- Table structure for table `amasty_groupassign_rule_table`
--

DROP TABLE IF EXISTS `amasty_groupassign_rule_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupassign_rule_table` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `rule_name` varchar(225) NOT NULL COMMENT 'Rule Name',
  `conditions_serialized` text NOT NULL COMMENT 'Serialized Conditions',
  `move_to_group` int(10) unsigned NOT NULL COMMENT 'Destination group id',
  `priority` int(11) NOT NULL COMMENT 'Priority of rul',
  `status` tinyint(1) NOT NULL COMMENT 'Status',
  PRIMARY KEY (`id`),
  KEY `FK_70E29CA0A470431DBC3A3070E29A50DD` (`move_to_group`),
  CONSTRAINT `FK_70E29CA0A470431DBC3A3070E29A50DD` FOREIGN KEY (`move_to_group`) REFERENCES `customer_group` (`customer_group_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Amasty Customer Group Auto Assign rules table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupassign_rule_table`
--

LOCK TABLES `amasty_groupassign_rule_table` WRITE;
/*!40000 ALTER TABLE `amasty_groupassign_rule_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `amasty_groupassign_rule_table` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_request`
--

DROP TABLE IF EXISTS `amasty_groupcat_request`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_request` (
  `request_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Request Id',
  ...
  `comment` text NOT NULL DEFAULT '' COMMENT 'Comment',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Creation Time',
  `status` smallint(6) NOT NULL DEFAULT 0 COMMENT 'Status',
  `message_text` text NOT NULL DEFAULT '' COMMENT 'Message Text',
  PRIMARY KEY (`request_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Amasty Groupcat Requests';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_request`
--

LOCK TABLES `amasty_groupcat_request` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `amasty_groupcat_request` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_rule`
--

DROP TABLE IF EXISTS `amasty_groupcat_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_rule` (
  ...
  `conditions_serialized` mediumtext DEFAULT NULL COMMENT 'Products Conditions serialized',
  `actions_serialized` mediumtext DEFAULT NULL COMMENT 'Customer Conditions serialized',
  `forbidden_action` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Action on forbid',
  `forbidden_page_id` smallint(6) DEFAULT NULL COMMENT 'CMS page on forbid',
  `allow_direct_links` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Allow direct links or not flag',
  `hide_product` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Remove Product or not flag',
  `hide_category` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Remove Category or not flag',
  `hide_cart` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Hide cart and show Price flag',
  `price_action` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Hide price, replace with block_id or show',
  `block_id_view` smallint(6) DEFAULT NULL COMMENT 'CMS block ID for price block replacement on product view',
  `block_id_list` smallint(6) DEFAULT NULL COMMENT 'CMS block ID for price block replacement on product list',
  `from_date` date DEFAULT NULL COMMENT 'From Date',
  `to_date` date DEFAULT NULL COMMENT 'To Date',
  `date_range_enabled` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Date range enabled',
  `customer_group_enabled` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Customer group enabled',
  `priority` int(11) NOT NULL DEFAULT 0 COMMENT 'Priority of the Rule',
  `hide_wishlist` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Hide Add to wishlist button or not flag',
  `hide_compare` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Hide Add to compare button or not flag',
  PRIMARY KEY (`rule_id`),
  KEY `AMASTY_GROUPCAT_RULE_FORBIDDEN_PAGE_ID` (`forbidden_page_id`),
  KEY `AMASTY_GROUPCAT_RULE_BLOCK_ID_VIEW` (`block_id_view`),
  KEY `AMASTY_GROUPCAT_RULE_BLOCK_ID_LIST` (`block_id_list`),
  CONSTRAINT `AMASTY_GROUPCAT_RULE_BLOCK_ID_LIST_CMS_BLOCK_BLOCK_ID` FOREIGN KEY (`block_id_list`) REFERENCES `cms_block` (`block_id`) ON DELETE NO ACTION,
  CONSTRAINT `AMASTY_GROUPCAT_RULE_BLOCK_ID_VIEW_CMS_BLOCK_BLOCK_ID` FOREIGN KEY (`block_id_view`) REFERENCES `cms_block` (`block_id`) ON DELETE NO ACTION,
  CONSTRAINT `AMASTY_GROUPCAT_RULE_FORBIDDEN_PAGE_ID_CMS_PAGE_PAGE_ID` FOREIGN KEY (`forbidden_page_id`) REFERENCES `cms_page` (`page_id`) ON DELETE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Customer Group Catalog Rule';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_rule`
--

LOCK TABLES `amasty_groupcat_rule` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_rule` DISABLE KEYS */;
INSERT INTO `amasty_groupcat_rule` VALUES (1,'Hide things for group2',1,'{\"type\":\"Amasty\\\\Groupcat\\\\Model\\\\Rule\\\\Condition\\\\Product\\\\Combine\",\"attribute\":null,\"operator\":null,\"value\":\"1\",\"is_value_processed\":null,\"aggregator\":\"all\",\"conditions\":[{\"type\":\"Magento\\\\CatalogRule\\\\Model\\\\Rule\\\\Condition\\\\Product\",\"attribute\":\"category_ids\",\"operator\":\"==\",\"value\":\"6\",\"is_value_processed\":false}]}','{\"type\":\"Amasty\\\\Groupcat\\\\Model\\\\Rule\\\\Condition\\\\Customer\\\\Combine\",\"attribute\":null,\"operator\":null,\"value\":true,\"is_value_processed\":null,\"aggregator\":\"all\"}',0,1,0,1,1,0,0,NULL,NULL,NULL,NULL,0,1,1,0,0),(2,'Hide things for group3',1,'{\"type\":\"Amasty\\\\Groupcat\\\\Model\\\\Rule\\\\Condition\\\\Product\\\\Combine\",\"attribute\":null,\"operator\":null,\"value\":\"1\",\"is_value_processed\":null,\"aggregator\":\"all\",\"conditions\":[{\"type\":\"Magento\\\\CatalogRule\\\\Model\\\\Rule\\\\Condition\\\\Product\",\"attribute\":\"category_ids\",\"operator\":\"==\",\"value\":\"5\",\"is_value_processed\":false}]}','{\"type\":\"Amasty\\\\Groupcat\\\\Model\\\\Rule\\\\Condition\\\\Customer\\\\Combine\",\"attribute\":null,\"operator\":null,\"value\":true,\"is_value_processed\":null,\"aggregator\":\"all\"}',0,1,0,1,1,0,0,NULL,NULL,NULL,NULL,0,1,1,0,0),(3,'Hide things for other groups',1,'{\"type\":\"Amasty\\\\Groupcat\\\\Model\\\\Rule\\\\Condition\\\\Product\\\\Combine\",\"attribute\":null,\"operator\":null,\"value\":\"1\",\"is_value_processed\":null,\"aggregator\":\"all\"}','{\"type\":\"Amasty\\\\Groupcat\\\\Model\\\\Rule\\\\Condition\\\\Customer\\\\Combine\",\"attribute\":null,\"operator\":null,\"value\":true,\"is_value_processed\":null,\"aggregator\":\"all\"}',0,1,0,0,1,0,0,NULL,NULL,NULL,NULL,0,1,1,0,0);
/*!40000 ALTER TABLE `amasty_groupcat_rule` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_rule_category`
--

DROP TABLE IF EXISTS `amasty_groupcat_rule_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_rule_category` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `category_id` int(10) unsigned NOT NULL COMMENT 'Catalog Category ID',
  PRIMARY KEY (`rule_id`,`category_id`),
  KEY `AMASTY_GROUPCAT_RULE_CTGR_CTGR_ID_CAT_CTGR_ENTT_ENTT_ID` (`category_id`),
  CONSTRAINT `AMASTY_GROUPCAT_RULE_CTGR_CTGR_ID_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`category_id`) REFERENCES `catalog_category_entity` (`entity_id`) ON DELETE CASCADE,
  CONSTRAINT `AMASTY_GROUPCAT_RULE_CTGR_RULE_ID_AMASTY_GROUPCAT_RULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `amasty_groupcat_rule` (`rule_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Rule Category Relation';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_rule_category`
--

LOCK TABLES `amasty_groupcat_rule_category` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_rule_category` DISABLE KEYS */;
INSERT INTO `amasty_groupcat_rule_category` VALUES (1,6),(2,5),(3,4),(3,5),(3,6),(3,7);
/*!40000 ALTER TABLE `amasty_groupcat_rule_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_rule_customer`
--

DROP TABLE IF EXISTS `amasty_groupcat_rule_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_rule_customer` (
  `rule_customer_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Customer Id',
  `rule_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Rule Id',
  `customer_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Customer Id',
  PRIMARY KEY (`rule_customer_id`),
  KEY `AMASTY_GROUPCAT_RULE_CUSTOMER_CUSTOMER_ID` (`customer_id`),
  KEY `AMASTY_GROUPCAT_RULE_CUSTOMER_RULE_ID_CUSTOMER_ID` (`rule_id`,`customer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=utf8 COMMENT='Rule Customer Matches';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_rule_customer`
--

LOCK TABLES `amasty_groupcat_rule_customer` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_rule_customer` DISABLE KEYS */;
INSERT INTO `amasty_groupcat_rule_customer` VALUES (136,1,1),(140,1,4),(137,2,2),(141,3,0),(139,3,3);
/*!40000 ALTER TABLE `amasty_groupcat_rule_customer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_rule_customer_group`
--

DROP TABLE IF EXISTS `amasty_groupcat_rule_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_rule_customer_group` (
  ...
  KEY `FK_CB356CEC5C2177ECEDD5B01271F40A6C` (`customer_group_id`),
  CONSTRAINT `FK_74FDB921EE3177A72FA9D4C781730BEC` FOREIGN KEY (`rule_id`) REFERENCES `amasty_groupcat_rule` (`rule_id`) ON DELETE CASCADE,
  CONSTRAINT `FK_CB356CEC5C2177ECEDD5B01271F40A6C` FOREIGN KEY (`customer_group_id`) REFERENCES `customer_group` (`customer_group_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Rule Customer Group Relation';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_rule_customer_group`
--

LOCK TABLES `amasty_groupcat_rule_customer_group` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_rule_customer_group` DISABLE KEYS */;
INSERT INTO `amasty_groupcat_rule_customer_group` VALUES (1,2),(2,3),(3,0),(3,1);
/*!40000 ALTER TABLE `amasty_groupcat_rule_customer_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_rule_product`
--

DROP TABLE IF EXISTS `amasty_groupcat_rule_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_rule_product` (
  `rule_product_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Product Id',
  `rule_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Rule Id',
  `from_time` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'From Time',
  `to_time` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'To time',
  `customer_group_enabled` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Customer Group Enabled',
  `customer_group_id` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Customer Group Id',
  `product_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Catalog Product Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  `price_action` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Hide, show or replace Price with block_id',
  `hide_cart` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Hide cart and show Price flag',
  `hide_product` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Remove Product or not flag',
  `priority` int(11) NOT NULL DEFAULT 0 COMMENT 'Priority of the Rule',
  `hide_wishlist` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Hide Add to wishlist button or not flag',
  ...
  UNIQUE KEY `IDX_A4AD497B15DF4D4CE8F4F0ADED3385A7` (`rule_id`,`from_time`,`to_time`,`store_id`,`customer_group_enabled`,`customer_group_id`,`product_id`,`priority`),
  KEY `AMASTY_GROUPCAT_RULE_PRODUCT_CUSTOMER_GROUP_ENABLED` (`customer_group_enabled`),
  KEY `AMASTY_GROUPCAT_RULE_PRODUCT_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `AMASTY_GROUPCAT_RULE_PRODUCT_STORE_ID` (`store_id`),
  KEY `AMASTY_GROUPCAT_RULE_PRODUCT_FROM_TIME` (`from_time`),
  KEY `AMASTY_GROUPCAT_RULE_PRODUCT_TO_TIME` (`to_time`),
  KEY `AMASTY_GROUPCAT_RULE_PRODUCT_PRODUCT_ID` (`product_id`),
  KEY `IDX_E286668ACA26DD3F08A659FAB4A12B89` (`from_time`,`to_time`,`product_id`,`price_action`,`customer_group_enabled`,`rule_id`,`store_id`,`customer_group_id`,`priority`)
) ENGINE=InnoDB AUTO_INCREMENT=453 DEFAULT CHARSET=utf8 COMMENT='Rule Catalog Product Matches';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_rule_product`
--

LOCK TABLES `amasty_groupcat_rule_product` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_rule_product` DISABLE KEYS */;
INSERT INTO `amasty_groupcat_rule_product` VALUES (437,1,0,0,1,2,3,3,0,0,1,1,0,0),(438,1,0,0,1,2,4,3,0,0,1,1,0,0),(439,2,0,0,1,3,1,3,0,0,1,1,0,0),(440,2,0,0,1,3,2,3,0,0,1,1,0,0),(441,3,0,0,1,0,1,3,0,0,0,1,0,0),(442,3,0,0,1,1,1,3,0,0,0,1,0,0),(443,3,0,0,1,0,2,3,0,0,0,1,0,0),(444,3,0,0,1,1,2,3,0,0,0,1,0,0),(445,3,0,0,1,0,3,3,0,0,0,1,0,0),(446,3,0,0,1,1,3,3,0,0,0,1,0,0),(447,3,0,0,1,0,4,3,0,0,0,1,0,0),(448,3,0,0,1,1,4,3,0,0,0,1,0,0),(449,3,0,0,1,0,5,3,0,0,0,1,0,0),(450,3,0,0,1,1,5,3,0,0,0,1,0,0),(451,3,0,0,1,0,6,3,0,0,0,1,0,0),(452,3,0,0,1,1,6,3,0,0,0,1,0,0);
/*!40000 ALTER TABLE `amasty_groupcat_rule_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amasty_groupcat_rule_store`
--

DROP TABLE IF EXISTS `amasty_groupcat_rule_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amasty_groupcat_rule_store` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store View ID',
  PRIMARY KEY (`rule_id`,`store_id`),
  KEY `AMASTY_GROUPCAT_RULE_STORE_STORE_ID_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `AMASTY_GROUPCAT_RULE_STORE_RULE_ID_AMASTY_GROUPCAT_RULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `amasty_groupcat_rule` (`rule_id`) ON DELETE CASCADE,
  CONSTRAINT `AMASTY_GROUPCAT_RULE_STORE_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Rule Store relation';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amasty_groupcat_rule_store`
--

LOCK TABLES `amasty_groupcat_rule_store` WRITE;
/*!40000 ALTER TABLE `amasty_groupcat_rule_store` DISABLE KEYS */;
INSERT INTO `amasty_groupcat_rule_store` VALUES (1,3),(2,3),(3,3);
/*!40000 ALTER TABLE `amasty_groupcat_rule_store` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `authorization_role` VALUES (1,0,1,1,'G',0,'2','Administrators'),(3,1,2,0,'U',2,'2','gjadmin');
...
INSERT INTO `captcha_log` VALUES ('2','admin',2,'2021-03-10 11:05:24');
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2021-02-11 14:37:40','2021-03-11 08:58:13','1',0,0,2),(2,3,1,'2021-02-11 14:37:40','2021-02-11 14:37:40','1/2',1,1,0),(3,3,1,'2021-03-11 08:58:13','2021-03-11 08:58:13','1/3',2,1,0);
...
INSERT INTO `catalog_category_entity_int` VALUES (1,69,0,1,1),(2,46,0,2,1),(3,69,0,2,1),(4,46,0,3,1),(5,54,0,3,1),(6,69,0,3,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Catalog Category Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_category_entity_varchar` VALUES (1,45,0,1,'Root Catalog'),(2,45,0,2,'Default Category'),(3,52,0,2,'PRODUCTS'),(4,45,0,3,'Giftcard Test'),(5,119,0,3,'giftcard-test');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Category Product Index Store8';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `catalog_category_product_index_store8`
--

LOCK TABLES `catalog_category_product_index_store8` WRITE;
/*!40000 ALTER TABLE `catalog_category_product_index_store8` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product_index_store8` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Category Product Index Store8 Replica';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `catalog_category_product_index_store8_replica`
--

LOCK TABLES `catalog_category_product_index_store8_replica` WRITE;
/*!40000 ALTER TABLE `catalog_category_product_index_store8_replica` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product_index_store8_replica` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Category Product Index Store9';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `catalog_category_product_index_store9`
--

LOCK TABLES `catalog_category_product_index_store9` WRITE;
/*!40000 ALTER TABLE `catalog_category_product_index_store9` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product_index_store9` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Category Product Index Store9 Replica';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `catalog_category_product_index_store9_replica`
--

LOCK TABLES `catalog_category_product_index_store9_replica` WRITE;
/*!40000 ALTER TABLE `catalog_category_product_index_store9_replica` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product_index_store9_replica` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `catalog_product_index_website` VALUES (1,1,'2021-03-22',1);
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'yotpo/module_info/yotpo_installation_date','2021-02-11','2021-02-11 14:37:35'),(2,'default',0,'yotpo/sync_settings/orders_sync_start_date','2021-02-11','2021-02-11 14:37:35'),(3,'default',0,'web/seo/use_rewrites','1','2021-02-11 14:37:36'),(4,'default',0,'web/unsecure/base_url','https://non-existent.url/','2021-02-11 14:37:36'),(5,'default',0,'web/secure/base_url','https://non-existent.url/','2021-02-11 14:37:36'),(6,'default',0,'general/locale/code','de_DE','2021-02-11 14:37:36'),(7,'default',0,'web/secure/use_in_frontend','0','2021-02-11 14:37:36'),(8,'default',0,'web/secure/use_in_adminhtml','1','2021-02-11 14:37:36'),(9,'default',0,'general/locale/timezone','Europe/Berlin','2021-02-11 14:37:36'),(10,'default',0,'currency/options/base','EUR','2021-02-11 14:37:36'),(11,'default',0,'currency/options/default','EUR','2021-02-11 14:37:36'),(12,'default',0,'currency/options/allow','EUR','2021-02-11 14:37:36'),(13,'default',0,'general/region/display_all','1','2021-02-11 14:37:37'),(14,'default',0,'general/region/state_required','AU,BG,BR,CA,CH,CN,CO,EE,ES,HR,IN,IT,LT,LV,MX,PL,RO,US,UY','2021-03-22 18:14:25'),(15,'default',0,'catalog/category/root_id','2','2021-02-11 14:37:40'),(16,'default',0,'analytics/subscription/enabled','1','2021-02-11 14:37:42'),(17,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2021-02-11 14:37:42'),(18,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2021-02-11 14:37:42'),(19,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2021-02-11 14:37:42'),(20,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2021-02-11 14:37:42'),(21,'default',0,'twofactorauth/duo/application_key','WJvUnkUAbCXsPyur8fxfLuQb75jNsHdGNUzAPgQFll0amNVDYOBslVdLnqnLNk6S','2021-02-11 14:37:42'),(22,'website',0,'connector_configuration/transactional_data/order_statuses','canceled,closed,complete,fraud,holded,payment_review,paypal_canceled_reversal,paypal_reversed,pending,pending_payment,pending_paypal,processing','2021-02-11 14:37:42'),(23,'website',0,'connector_configuration/catalog_sync/catalog_type','simple,virtual,downloadable,configurable,grouped,bundle','2021-02-11 14:37:42'),(24,'website',0,'connector_configuration/catalog_sync/catalog_visibility','1,2,3,4','2021-02-11 14:37:42'),(25,'default',0,'connector_dynamic_content/external_dynamic_content_urls/passcode','wgaQww2r00joFs35pmYY02cCp21XM97r','2021-02-11 14:37:42'),(26,'default',0,'connector_automation/review_settings/allow_non_subscribers','1','2021-02-11 14:37:42'),(27,'default',0,'connector_configuration/abandoned_carts/allow_non_subscribers','1','2021-02-11 14:37:42'),(28,'default',0,'sync_settings/addressbook/allow_non_subscribers','1','2021-02-11 14:37:42'),(29,'default',0,'connector_developer_settings/system_alerts/user_roles','1','2021-02-11 14:37:42'),(30,'default',0,'twofactorauth/general/force_providers','google','2021-03-11 11:48:39'),(31,'default',0,'admin/usage/enabled','0','2021-03-11 11:49:23');
...
) ENGINE=InnoDB AUTO_INCREMENT=703 DEFAULT CHARSET=utf8 COMMENT='Cron Schedule';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cron_schedule` VALUES (359,'catalog_product_outdated_price_values_cleanup','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(360,'catalog_product_outdated_price_values_cleanup','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:02','2021-03-26 07:16:02'),(361,'catalog_product_outdated_price_values_cleanup','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(362,'catalog_product_outdated_price_values_cleanup','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(363,'catalog_product_outdated_price_values_cleanup','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(364,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(365,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(366,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(367,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(368,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(369,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(370,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(371,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(372,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(373,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(374,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(375,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(376,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(377,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(378,'catalog_product_outdated_price_values_cleanup','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(379,'catalog_product_frontend_actions_flush','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(380,'catalog_product_frontend_actions_flush','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(381,'catalog_product_frontend_actions_flush','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(382,'catalog_product_frontend_actions_flush','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(383,'catalog_product_frontend_actions_flush','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(384,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(385,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(386,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(387,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(388,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(389,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(390,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(391,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(392,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(393,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(394,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(395,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(396,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(397,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(398,'catalog_product_frontend_actions_flush','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(399,'catalog_product_attribute_value_synchronize','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(400,'catalog_product_attribute_value_synchronize','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(401,'catalog_product_attribute_value_synchronize','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(402,'catalog_product_attribute_value_synchronize','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(403,'sales_grid_order_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(404,'sales_grid_order_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(405,'sales_grid_order_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(406,'sales_grid_order_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(407,'sales_grid_order_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(408,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(409,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(410,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(411,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(412,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(413,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(414,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(415,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(416,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(417,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(418,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(419,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(420,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(421,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(422,'sales_grid_order_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(423,'sales_grid_order_invoice_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(424,'sales_grid_order_invoice_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(425,'sales_grid_order_invoice_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(426,'sales_grid_order_invoice_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(427,'sales_grid_order_invoice_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(428,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(429,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(430,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(431,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(432,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(433,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(434,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(435,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(436,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(437,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(438,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(439,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(440,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(441,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(442,'sales_grid_order_invoice_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(443,'sales_grid_order_shipment_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(444,'sales_grid_order_shipment_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(445,'sales_grid_order_shipment_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(446,'sales_grid_order_shipment_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(447,'sales_grid_order_shipment_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(448,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(449,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(450,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(451,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(452,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(453,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(454,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(455,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(456,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(457,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(458,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(459,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(460,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(461,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(462,'sales_grid_order_shipment_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(463,'sales_grid_order_creditmemo_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(464,'sales_grid_order_creditmemo_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(465,'sales_grid_order_creditmemo_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(466,'sales_grid_order_creditmemo_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(467,'sales_grid_order_creditmemo_async_insert','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(468,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(469,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(470,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(471,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(472,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(473,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(474,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(475,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(476,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(477,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(478,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(479,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(480,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(481,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(482,'sales_grid_order_creditmemo_async_insert','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(483,'sales_send_order_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(484,'sales_send_order_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(485,'sales_send_order_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(486,'sales_send_order_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(487,'sales_send_order_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(488,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(489,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(490,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(491,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(492,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(493,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(494,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(495,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(496,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(497,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(498,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(499,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(500,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(501,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(502,'sales_send_order_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(503,'sales_send_order_invoice_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(504,'sales_send_order_invoice_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(505,'sales_send_order_invoice_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(506,'sales_send_order_invoice_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(507,'sales_send_order_invoice_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(508,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(509,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(510,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(511,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(512,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(513,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(514,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(515,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(516,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(517,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(518,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(519,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(520,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(521,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(522,'sales_send_order_invoice_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(523,'sales_send_order_shipment_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(524,'sales_send_order_shipment_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(525,'sales_send_order_shipment_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(526,'sales_send_order_shipment_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(527,'sales_send_order_shipment_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(528,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(529,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(530,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(531,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(532,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:24:00',NULL,NULL),(533,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:25:00',NULL,NULL),(534,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:26:00',NULL,NULL),(535,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:27:00',NULL,NULL),(536,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:28:00',NULL,NULL),(537,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:29:00',NULL,NULL),(538,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:30:00',NULL,NULL),(539,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:31:00',NULL,NULL),(540,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:32:00',NULL,NULL),(541,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:33:00',NULL,NULL),(542,'sales_send_order_shipment_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:34:00',NULL,NULL),(543,'sales_send_order_creditmemo_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(544,'sales_send_order_creditmemo_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(545,'sales_send_order_creditmemo_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(546,'sales_send_order_creditmemo_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(547,'sales_send_order_creditmemo_emails','success',NULL,'2021-03-26 07:15:05','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(548,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:20:00',NULL,NULL),(549,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:21:00',NULL,NULL),(550,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:22:00',NULL,NULL),(551,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:05','2021-03-26 07:23:00',NULL,NULL),(552,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:24:00',NULL,NULL),(553,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:25:00',NULL,NULL),(554,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:26:00',NULL,NULL),(555,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:27:00',NULL,NULL),(556,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:28:00',NULL,NULL),(557,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:29:00',NULL,NULL),(558,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(559,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:31:00',NULL,NULL),(560,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:32:00',NULL,NULL),(561,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:33:00',NULL,NULL),(562,'sales_send_order_creditmemo_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:34:00',NULL,NULL),(563,'outdated_authentication_failures_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(564,'outdated_authentication_failures_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(565,'outdated_authentication_failures_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(566,'outdated_authentication_failures_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(567,'outdated_authentication_failures_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(568,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:20:00',NULL,NULL),(569,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:21:00',NULL,NULL),(570,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:22:00',NULL,NULL),(571,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:23:00',NULL,NULL),(572,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:24:00',NULL,NULL),(573,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:25:00',NULL,NULL),(574,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:26:00',NULL,NULL),(575,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:27:00',NULL,NULL),(576,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:28:00',NULL,NULL),(577,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:29:00',NULL,NULL),(578,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(579,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:31:00',NULL,NULL),(580,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:32:00',NULL,NULL),(581,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:33:00',NULL,NULL),(582,'outdated_authentication_failures_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:34:00',NULL,NULL),(583,'captcha_delete_old_attempts','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(584,'captcha_delete_expired_images','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:20:00',NULL,NULL),(585,'captcha_delete_expired_images','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(586,'inventory_in_store_pickup_sales_send_order_notified_emails','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(587,'inventory_in_store_pickup_sales_send_order_notified_emails','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(588,'inventory_in_store_pickup_sales_send_order_notified_emails','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(589,'inventory_in_store_pickup_sales_send_order_notified_emails','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(590,'inventory_in_store_pickup_sales_send_order_notified_emails','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(591,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:20:00',NULL,NULL),(592,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:21:00',NULL,NULL),(593,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:22:00',NULL,NULL),(594,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:23:00',NULL,NULL),(595,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:24:00',NULL,NULL),(596,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:25:00',NULL,NULL),(597,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:26:00',NULL,NULL),(598,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:27:00',NULL,NULL),(599,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:28:00',NULL,NULL),(600,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:29:00',NULL,NULL),(601,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(602,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:31:00',NULL,NULL),(603,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:32:00',NULL,NULL),(604,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:33:00',NULL,NULL),(605,'inventory_in_store_pickup_sales_send_order_notified_emails','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:34:00',NULL,NULL),(606,'magento_newrelicreporting_cron','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(607,'magento_newrelicreporting_cron','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(608,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:20:00',NULL,NULL),(609,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:22:00',NULL,NULL),(610,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:24:00',NULL,NULL),(611,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:26:00',NULL,NULL),(612,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:28:00',NULL,NULL),(613,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(614,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:32:00',NULL,NULL),(615,'magento_newrelicreporting_cron','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:34:00',NULL,NULL),(616,'newsletter_send_all','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(617,'newsletter_send_all','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:20:00',NULL,NULL),(618,'newsletter_send_all','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:25:00',NULL,NULL),(619,'newsletter_send_all','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(620,'bulk_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:15:00','2021-03-26 07:15:06','2021-03-26 07:15:06'),(621,'bulk_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:16:00','2021-03-26 07:16:03','2021-03-26 07:16:03'),(622,'bulk_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:17:00','2021-03-26 07:17:02','2021-03-26 07:17:02'),(623,'bulk_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:18:00','2021-03-26 07:18:02','2021-03-26 07:18:02'),(624,'bulk_cleanup','success',NULL,'2021-03-26 07:15:06','2021-03-26 07:19:00','2021-03-26 07:19:02','2021-03-26 07:19:02'),(625,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:20:00',NULL,NULL),(626,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:21:00',NULL,NULL),(627,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:22:00',NULL,NULL),(628,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:23:00',NULL,NULL),(629,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:24:00',NULL,NULL),(630,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:25:00',NULL,NULL),(631,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:26:00',NULL,NULL),(632,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:27:00',NULL,NULL),(633,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:28:00',NULL,NULL),(634,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:29:00',NULL,NULL),(635,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:30:00',NULL,NULL),(636,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:31:00',NULL,NULL),(637,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:32:00',NULL,NULL),(638,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:33:00',NULL,NULL),(639,'bulk_cleanup','pending',NULL,'2021-03-26 07:15:06','2021-03-26 07:34:00',NULL,NULL),(640,'ddg_automation_customer_subscriber_guest_sync','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(641,'ddg_automation_importer','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(642,'ddg_automation_status','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:16:00','2021-03-26 07:16:04','2021-03-26 07:16:04'),(643,'ddg_automation_reviews_and_wishlist','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(644,'ddg_automation_campaign','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(645,'ddg_automation_order_sync','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(646,'ddg_automation_catalog_sync','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(647,'ddg_automation_monitor','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(648,'ddg_automation_sms_order_messages','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:07','2021-03-26 07:15:07'),(649,'ddg_automation_sms_order_messages','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:16:00','2021-03-26 07:16:04','2021-03-26 07:16:04'),(650,'ddg_automation_sms_order_messages','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:17:00','2021-03-26 07:17:04','2021-03-26 07:17:04'),(651,'ddg_automation_sms_order_messages','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:18:00','2021-03-26 07:18:03','2021-03-26 07:18:03'),(652,'ddg_automation_abandonedcarts','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(653,'yotpo_yotpo_orders_sync','success',NULL,'2021-03-26 07:15:07','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(654,'yotpo_yotpo_orders_sync','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:16:00','2021-03-26 07:16:04','2021-03-26 07:16:04'),(655,'yotpo_yotpo_orders_sync','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:17:00','2021-03-26 07:17:04','2021-03-26 07:17:04'),(656,'indexer_reindex_all_invalid','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(657,'yotpo_yotpo_orders_sync','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:18:00','2021-03-26 07:18:04','2021-03-26 07:18:04'),(658,'indexer_reindex_all_invalid','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:16:00','2021-03-26 07:16:04','2021-03-26 07:16:04'),(659,'indexer_reindex_all_invalid','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:17:00','2021-03-26 07:17:03','2021-03-26 07:17:03'),(660,'indexer_reindex_all_invalid','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:18:00','2021-03-26 07:18:03','2021-03-26 07:18:03'),(661,'indexer_update_all_views','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(662,'indexer_update_all_views','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:16:00','2021-03-26 07:16:04','2021-03-26 07:16:04'),(663,'indexer_update_all_views','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:17:00','2021-03-26 07:17:03','2021-03-26 07:17:03'),(664,'indexer_update_all_views','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:18:00','2021-03-26 07:18:03','2021-03-26 07:18:03'),(665,'consumers_runner','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:15:00','2021-03-26 07:15:08','2021-03-26 07:15:08'),(666,'consumers_runner','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:16:00','2021-03-26 07:16:04','2021-03-26 07:16:04'),(667,'consumers_runner','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:17:00','2021-03-26 07:17:04','2021-03-26 07:17:04'),(668,'consumers_runner','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:18:00','2021-03-26 07:18:03','2021-03-26 07:18:03'),(669,'consumers_runner','success',NULL,'2021-03-26 07:15:08','2021-03-26 07:19:00','2021-03-26 07:19:03','2021-03-26 07:19:03'),(670,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:20:00',NULL,NULL),(671,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:21:00',NULL,NULL),(672,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:22:00',NULL,NULL),(673,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:23:00',NULL,NULL),(674,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:24:00',NULL,NULL),(675,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:25:00',NULL,NULL),(676,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:26:00',NULL,NULL),(677,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:27:00',NULL,NULL),(678,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:28:00',NULL,NULL),(679,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:29:00',NULL,NULL),(680,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:30:00',NULL,NULL),(681,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:31:00',NULL,NULL),(682,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:32:00',NULL,NULL),(683,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:33:00',NULL,NULL),(684,'consumers_runner','pending',NULL,'2021-03-26 07:15:08','2021-03-26 07:34:00',NULL,NULL),(685,'indexer_reindex_all_invalid','success',NULL,'2021-03-26 07:17:03','2021-03-26 07:19:00','2021-03-26 07:19:03','2021-03-26 07:19:03'),(686,'indexer_reindex_all_invalid','pending',NULL,'2021-03-26 07:17:03','2021-03-26 07:20:00',NULL,NULL),(687,'indexer_update_all_views','success',NULL,'2021-03-26 07:17:03','2021-03-26 07:19:00','2021-03-26 07:19:03','2021-03-26 07:19:03'),(688,'indexer_update_all_views','pending',NULL,'2021-03-26 07:17:03','2021-03-26 07:20:00',NULL,NULL),(689,'ddg_automation_abandonedcarts','pending',NULL,'2021-03-26 07:17:03','2021-03-26 07:20:00',NULL,NULL),(690,'ddg_automation_sms_order_messages','success',NULL,'2021-03-26 07:17:04','2021-03-26 07:19:00','2021-03-26 07:19:03','2021-03-26 07:19:03'),(691,'ddg_automation_sms_order_messages','pending',NULL,'2021-03-26 07:17:04','2021-03-26 07:20:00',NULL,NULL),(692,'ddg_automation_importer','pending',NULL,'2021-03-26 07:17:04','2021-03-26 07:20:00',NULL,NULL),(693,'ddg_automation_campaign','pending',NULL,'2021-03-26 07:17:04','2021-03-26 07:20:00',NULL,NULL),(694,'yotpo_yotpo_orders_sync','success',NULL,'2021-03-26 07:17:04','2021-03-26 07:19:00','2021-03-26 07:19:03','2021-03-26 07:19:03'),(695,'yotpo_yotpo_orders_sync','pending',NULL,'2021-03-26 07:17:04','2021-03-26 07:20:00',NULL,NULL),(696,'indexer_reindex_all_invalid','pending',NULL,'2021-03-26 07:18:03','2021-03-26 07:21:00',NULL,NULL),(697,'indexer_update_all_views','pending',NULL,'2021-03-26 07:18:03','2021-03-26 07:21:00',NULL,NULL),(698,'yotpo_yotpo_orders_sync','pending',NULL,'2021-03-26 07:18:04','2021-03-26 07:21:00',NULL,NULL),(699,'ddg_automation_sms_order_messages','pending',NULL,'2021-03-26 07:19:03','2021-03-26 07:21:00',NULL,NULL),(700,'ddg_automation_sms_order_messages','pending',NULL,'2021-03-26 07:19:03','2021-03-26 07:22:00',NULL,NULL),(701,'indexer_reindex_all_invalid','pending',NULL,'2021-03-26 07:19:03','2021-03-26 07:22:00',NULL,NULL),(702,'indexer_update_all_views','pending',NULL,'2021-03-26 07:19:03','2021-03-26 07:22:00',NULL,NULL);
...
INSERT INTO `customer_entity` VALUES (1,1,'john+magentobasetest@getjohn.co.uk',1,NULL,1,'2021-03-26 07:16:26','2021-03-26 07:18:05',1,0,'Default Store View',NULL,'johnny',NULL,'tester',NULL,NULL,'9aa3317ff79fe9c2426e6c8562bda459c9f76358f3d1ce5125ee4769cf0937d7:h2r71fie6WmSJYACPiDXGARm7Th9WZuf:3_32_2_67108864','5zP3Kn1Dz0OyvV0x77bA9FiVqJSMoEXS','2021-03-26 07:16:26',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL);
...
INSERT INTO `customer_grid_flat` VALUES (1,'johnny tester','john+magentobasetest@getjohn.co.uk',1,'2021-03-26 07:16:26',1,NULL,'Default Store View',NULL,NULL,NULL,NULL,'','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `customer_log` VALUES (1,1,'2021-03-26 07:18:05',NULL);
...
INSERT INTO `customer_visitor` VALUES (1,1,'eq9863vefg76f2odgqlnvter0s','2021-03-26 07:18:05');
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2021-02-11 14:37:42'),(2,'catalog_website_attribute_is_sync_required',0,'0','2021-03-22 18:15:03');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2021-03-26 07:14:23','a3eeee1d7ce8b434c0bb03561cb2673c'),(2,'customer_grid','valid','2021-02-11 14:43:24','5790cd3be2be34413537c9b0afc3a0f8'),(3,'catalog_category_product','valid','2021-03-22 18:14:03','244752ab8f5ce55e37f000fd6a76457c'),(4,'catalog_product_category','valid','2021-03-22 18:14:03','c29e58d23abac6325eb3471cc85b06c2'),(5,'catalogrule_rule','valid','2021-03-22 18:14:03','7b31f80fd3bd65991c98bb2c34da1858'),(6,'catalog_product_attribute','valid','2021-03-22 18:14:03','99d07bbf0eb01674f2b7ccb1a8c2e70b'),(7,'cataloginventory_stock','valid','2021-03-22 18:14:03','4de28a06eb577f978097a1073d31ea73'),(8,'inventory','valid','2021-03-22 18:14:03','37111bff1b4dad1667565ea26bd62175'),(9,'catalogrule_product','valid','2021-03-22 18:14:03','8d488763d83150fd84a8ee5c1f09791d'),(10,'catalog_product_price','valid','2021-03-22 18:14:04','177a4ce848abc3b346508888c7517185'),(11,'catalogsearch_fulltext','valid','2021-03-22 18:14:04','f42fa186cc393b0e4284f36761b8971e');
...
--
-- Table structure for table `mageworx_giftcard_order`
--

DROP TABLE IF EXISTS `mageworx_giftcard_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mageworx_giftcard_order` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `giftcard_id` int(10) unsigned NOT NULL COMMENT 'Used Gift Card Id',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order Id for used Gift Card',
  `discounted` decimal(12,4) DEFAULT NULL COMMENT 'Gift Card Used Amount',
  `created_time` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Updated At',
  `giftcard_code` varchar(255) DEFAULT NULL COMMENT 'Used Gift Card Code',
  `order_increment_id` varchar(50) DEFAULT NULL COMMENT 'Order Increment Id',
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='mageworx_giftcard_order';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mageworx_giftcard_order`
--

LOCK TABLES `mageworx_giftcard_order` WRITE;
/*!40000 ALTER TABLE `mageworx_giftcard_order` DISABLE KEYS */;
INSERT INTO `mageworx_giftcard_order` VALUES (1,1,2,29.0000,'2021-03-15 13:03:48','2021-03-15 13:03:48','ID1GB-P71A7-54XAQ','3000000002'),(2,1,4,27.3000,'2021-03-15 13:09:26','2021-03-15 13:09:26','ID1GB-P71A7-54XAQ','3000000004'),(3,2,6,29.0000,'2021-03-15 14:10:38','2021-03-15 14:10:38','JDNB8-BDUNI-KTNMJ','3000000006'),(4,2,7,1.0000,'2021-03-15 14:13:59','2021-03-15 14:13:59','JDNB8-BDUNI-KTNMJ','3000000007'),(5,1,8,70.0000,'2021-03-15 14:21:08','2021-03-15 14:21:08','ID1GB-P71A7-54XAQ','3000000008'),(6,1,9,71.0000,'2021-03-15 14:24:08','2021-03-15 14:24:08','ID1GB-P71A7-54XAQ','3000000009'),(7,3,11,65.0000,'2021-03-15 15:19:53','2021-03-15 15:19:53','5IBZ0-MF65G-V143V','3000000011');
/*!40000 ALTER TABLE `mageworx_giftcard_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mageworx_giftcards_card`
--

DROP TABLE IF EXISTS `mageworx_giftcards_card`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mageworx_giftcards_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `card_code` varchar(255) DEFAULT NULL COMMENT 'Gift Card Code',
  `customer_id` int(10) unsigned NOT NULL COMMENT 'Gift Card Customer Id',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Gift Card Order Id',
  `product_id` int(10) unsigned NOT NULL COMMENT 'Gift Card Product Id',
  `card_currency` varchar(3) DEFAULT NULL COMMENT 'Gift Card Currency',
  `card_amount` decimal(12,4) DEFAULT NULL COMMENT 'Gift Card Amount',
  `card_balance` decimal(12,4) DEFAULT NULL COMMENT 'Gift Card Current Balance',
  `card_status` smallint(5) unsigned DEFAULT 0 COMMENT 'Gift Card Status',
  `card_type` smallint(5) unsigned DEFAULT 0 COMMENT 'Gift Card Type',
  `mail_from` varchar(255) DEFAULT NULL COMMENT 'Gift Card Mail Sender',
  `mail_to` varchar(255) DEFAULT NULL COMMENT 'Gift Card Owner',
  `mail_to_email` varchar(255) DEFAULT NULL COMMENT 'Gift Card Owner Email',
  `mail_message` text DEFAULT NULL COMMENT 'Gift Card Email Message',
  `offline_country` varchar(255) DEFAULT NULL COMMENT 'Offline Gift Card Country',
  `offline_state` varchar(255) DEFAULT NULL COMMENT 'Offline Gift Card State',
  `offline_city` varchar(255) DEFAULT NULL COMMENT 'Offline Gift Card City',
  `offline_street` varchar(255) DEFAULT NULL COMMENT 'Offline Gift Card Street',
  `offline_zip` varchar(255) DEFAULT NULL COMMENT 'Offline Gift Card ZIP',
  `offline_phone` varchar(255) DEFAULT NULL COMMENT 'Offline Gift Card Phone',
  `mail_delivery_date` date DEFAULT NULL COMMENT 'Gift Card Mail Delivery Date',
  `created_time` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Updated At',
  `expire_date` date DEFAULT NULL COMMENT 'Expire Date',
  `expired_email_send` tinyint(1) DEFAULT 0 COMMENT 'Is Expired Email Send',
  `expiration_alert_email_send` tinyint(1) DEFAULT 0 COMMENT 'Is Expiration Alert Email Send',
  `delivery_status` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Delivery Status',
  `store_id_for_email` smallint(5) unsigned DEFAULT NULL COMMENT 'Send From Store Id',
  PRIMARY KEY (`card_id`),
  UNIQUE KEY `MAGEWORX_GIFTCARDS_CARD_CARD_CODE` (`card_code`),
  KEY `MAGEWORX_GIFTCARDS_CARD_STORE_ID_FOR_EMAIL_STORE_STORE_ID` (`store_id_for_email`),
  CONSTRAINT `MAGEWORX_GIFTCARDS_CARD_STORE_ID_FOR_EMAIL_STORE_STORE_ID` FOREIGN KEY (`store_id_for_email`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='mageworx_giftcards_card';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mageworx_giftcards_card`
--

LOCK TABLES `mageworx_giftcards_card` WRITE;
/*!40000 ALTER TABLE `mageworx_giftcards_card` DISABLE KEYS */;
INSERT INTO `mageworx_giftcards_card` VALUES (1,'ID1GB-P71A7-54XAQ',1,1,1,'USD',65.0000,10.0000,1,1,'Johnny From','Johnny Too','john+testgift65usd@getjohn.co.uk','this 65USD',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2021-03-15 12:53:36','2021-03-15 15:33:06','2021-03-14',1,0,1,3),(2,'JDNB8-BDUNI-KTNMJ',1,5,1,'GBP',30.0000,0.0000,2,1,'Johnny From','Johnny Too','john+testgift30gbp@getjohn.co.uk',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2021-03-15','2021-03-15 14:08:36','2021-03-15 15:33:01','2021-03-14',0,0,1,3),(3,'5IBZ0-MF65G-V143V',1,10,1,'USD',65.0000,0.0000,2,1,'Johnny From','Johnny Too','john@getjohn.co.uk','test 65USD',NULL,NULL,NULL,NULL,NULL,NULL,'2021-03-15','2021-03-15 14:52:24','2021-03-15 15:33:01','2021-03-14',0,0,1,3),(4,'JMF5T-N9IHJ-N9K7T',0,0,0,'USD',65.0000,65.0000,1,1,'johnny from','johnny to','john@getjohn.co.uk','test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2021-03-15 15:27:12','2021-03-15 15:33:06','2021-03-14',1,0,0,3),(5,'UBRV7-F4HBS-SS18R',1,12,1,'USD',65.0000,65.0000,1,1,'Johnny From','Johnny Too','john+testccogift@getjohn.co.uk','a USD 65 card',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2021-03-20 13:51:12','2021-03-20 13:51:14','2021-03-27',0,0,1,3),(6,'Q6SIE-EXQGV-AP3XB',1,12,1,'USD',65.0000,65.0000,1,1,'johnny from','johnny to','john+testgiftcard@getjohn.co.uk','this is a 65 USD test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2021-03-20 13:51:12','2021-03-20 13:51:15','2021-03-27',0,0,1,3);
/*!40000 ALTER TABLE `mageworx_giftcards_card` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mageworx_giftcards_customer_group`
--

DROP TABLE IF EXISTS `mageworx_giftcards_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mageworx_giftcards_customer_group` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Card Id',
  `customer_group_id` int(10) unsigned NOT NULL COMMENT 'Customer Group Id',
  PRIMARY KEY (`card_id`,`customer_group_id`),
  KEY `MAGEWORX_GIFTCARDS_CUSTOMER_GROUP_CUSTOMER_GROUP_ID` (`customer_group_id`),
  CONSTRAINT `FK_E1D2D9789C434CFDAF03B343B5EE1779` FOREIGN KEY (`customer_group_id`) REFERENCES `customer_group` (`customer_group_id`) ON DELETE CASCADE,
  CONSTRAINT `MAGEWORX_GIFTCARDS_CSTR_GROUP_CARD_ID_MAGEWORX_GIFTCARDS_CARD_ID` FOREIGN KEY (`card_id`) REFERENCES `mageworx_giftcards_card` (`card_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='MageWorx Giftcards To Customer Groups Relations';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mageworx_giftcards_customer_group`
--

LOCK TABLES `mageworx_giftcards_customer_group` WRITE;
/*!40000 ALTER TABLE `mageworx_giftcards_customer_group` DISABLE KEYS */;
INSERT INTO `mageworx_giftcards_customer_group` VALUES (1,0),(1,1),(1,2),(1,3),(2,0),(2,1),(2,2),(2,3),(3,0),(3,1),(3,2),(3,3),(4,0),(4,1),(4,2),(4,3),(5,0),(5,1),(5,2),(5,3),(6,0),(6,1),(6,2),(6,3);
/*!40000 ALTER TABLE `mageworx_giftcards_customer_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mageworx_giftcards_store`
--

DROP TABLE IF EXISTS `mageworx_giftcards_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mageworx_giftcards_store` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Card ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  PRIMARY KEY (`card_id`,`store_id`),
  KEY `MAGEWORX_GIFTCARDS_STORE_STORE_ID_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `MAGEWORX_GIFTCARDS_STORE_CARD_ID_MAGEWORX_GIFTCARDS_CARD_CARD_ID` FOREIGN KEY (`card_id`) REFERENCES `mageworx_giftcards_card` (`card_id`) ON DELETE CASCADE,
  CONSTRAINT `MAGEWORX_GIFTCARDS_STORE_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='MageWorx Giftcards To Stores Relations';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mageworx_giftcards_store`
--

LOCK TABLES `mageworx_giftcards_store` WRITE;
/*!40000 ALTER TABLE `mageworx_giftcards_store` DISABLE KEYS */;
INSERT INTO `mageworx_giftcards_store` VALUES (1,3),(2,3),(3,3),(4,3),(5,3),(6,3);
/*!40000 ALTER TABLE `mageworx_giftcards_store` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `queue_poison_pill` VALUES ('version-604a03c40fdef');
...
INSERT INTO `quote` VALUES (1,1,'2021-03-26 07:18:05','2021-03-26 07:18:05',NULL,1,0,0,0,0.0000,0,0.0000,0.0000,'EUR','EUR','EUR',0.0000,0.0000,NULL,1,NULL,1,'john+magentobasetest@getjohn.co.uk',NULL,'johnny',NULL,'tester',NULL,NULL,NULL,1,0,'94.13.145.45',NULL,NULL,NULL,NULL,'EUR',1.0000,1.0000,NULL,NULL,0.0000,0.0000,0.0000,0.0000,1,0,NULL,NULL,0);
...
INSERT INTO `quote_address` VALUES (1,1,'2021-03-26 07:18:05','2021-03-26 07:18:05',1,0,NULL,'billing','john+magentobasetest@getjohn.co.uk',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,NULL,'null',NULL,0.0000,0.0000,0.0000,NULL,0.0000,0.0000,0.0000,NULL,0.0000,0.0000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(2,1,'2021-03-26 07:18:05','2021-03-26 07:18:05',1,0,NULL,'shipping','john+magentobasetest@getjohn.co.uk',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,NULL,NULL,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,NULL,'null',NULL,0.0000,0.0000,0.0000,NULL,0.0000,0.0000,0.0000,NULL,0.0000,0.0000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);
...
--
-- Dumping data for table `sequence_creditmemo_11`
--

LOCK TABLES `sequence_creditmemo_11` WRITE;
/*!40000 ALTER TABLE `sequence_creditmemo_11` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_creditmemo_11` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_creditmemo_12`
--

LOCK TABLES `sequence_creditmemo_12` WRITE;
/*!40000 ALTER TABLE `sequence_creditmemo_12` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_creditmemo_12` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_creditmemo_13`
--

LOCK TABLES `sequence_creditmemo_13` WRITE;
/*!40000 ALTER TABLE `sequence_creditmemo_13` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_creditmemo_13` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_creditmemo_14`
--

LOCK TABLES `sequence_creditmemo_14` WRITE;
/*!40000 ALTER TABLE `sequence_creditmemo_14` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_creditmemo_14` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_creditmemo_15`
--

DROP TABLE IF EXISTS `sequence_creditmemo_15`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_creditmemo_15` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_creditmemo_15`
--

LOCK TABLES `sequence_creditmemo_15` WRITE;
/*!40000 ALTER TABLE `sequence_creditmemo_15` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_creditmemo_15` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_creditmemo_16`
--

DROP TABLE IF EXISTS `sequence_creditmemo_16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_creditmemo_16` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_creditmemo_16`
--

LOCK TABLES `sequence_creditmemo_16` WRITE;
/*!40000 ALTER TABLE `sequence_creditmemo_16` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_creditmemo_16` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_invoice_11`
--

LOCK TABLES `sequence_invoice_11` WRITE;
/*!40000 ALTER TABLE `sequence_invoice_11` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_invoice_11` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_invoice_12`
--

LOCK TABLES `sequence_invoice_12` WRITE;
/*!40000 ALTER TABLE `sequence_invoice_12` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_invoice_12` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_invoice_13`
--

LOCK TABLES `sequence_invoice_13` WRITE;
/*!40000 ALTER TABLE `sequence_invoice_13` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_invoice_13` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_invoice_14`
--

LOCK TABLES `sequence_invoice_14` WRITE;
/*!40000 ALTER TABLE `sequence_invoice_14` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_invoice_14` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_invoice_15`
--

DROP TABLE IF EXISTS `sequence_invoice_15`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_invoice_15` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_invoice_15`
--

LOCK TABLES `sequence_invoice_15` WRITE;
/*!40000 ALTER TABLE `sequence_invoice_15` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_invoice_15` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_invoice_16`
--

DROP TABLE IF EXISTS `sequence_invoice_16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_invoice_16` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_invoice_16`
--

LOCK TABLES `sequence_invoice_16` WRITE;
/*!40000 ALTER TABLE `sequence_invoice_16` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_invoice_16` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_order_11`
--

LOCK TABLES `sequence_order_11` WRITE;
/*!40000 ALTER TABLE `sequence_order_11` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_order_11` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_order_12`
--

LOCK TABLES `sequence_order_12` WRITE;
/*!40000 ALTER TABLE `sequence_order_12` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_order_12` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_order_13`
--

LOCK TABLES `sequence_order_13` WRITE;
/*!40000 ALTER TABLE `sequence_order_13` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_order_13` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_order_14`
--

LOCK TABLES `sequence_order_14` WRITE;
/*!40000 ALTER TABLE `sequence_order_14` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_order_14` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_order_15`
--

DROP TABLE IF EXISTS `sequence_order_15`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_order_15` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_order_15`
--

LOCK TABLES `sequence_order_15` WRITE;
/*!40000 ALTER TABLE `sequence_order_15` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_order_15` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_order_16`
--

DROP TABLE IF EXISTS `sequence_order_16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_order_16` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_order_16`
--

LOCK TABLES `sequence_order_16` WRITE;
/*!40000 ALTER TABLE `sequence_order_16` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_order_16` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_shipment_11`
--

LOCK TABLES `sequence_shipment_11` WRITE;
/*!40000 ALTER TABLE `sequence_shipment_11` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_shipment_11` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_shipment_12`
--

LOCK TABLES `sequence_shipment_12` WRITE;
/*!40000 ALTER TABLE `sequence_shipment_12` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_shipment_12` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_shipment_13`
--

LOCK TABLES `sequence_shipment_13` WRITE;
/*!40000 ALTER TABLE `sequence_shipment_13` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_shipment_13` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sequence_shipment_14`
--

LOCK TABLES `sequence_shipment_14` WRITE;
/*!40000 ALTER TABLE `sequence_shipment_14` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_shipment_14` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_shipment_15`
--

DROP TABLE IF EXISTS `sequence_shipment_15`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_shipment_15` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_shipment_15`
--

LOCK TABLES `sequence_shipment_15` WRITE;
/*!40000 ALTER TABLE `sequence_shipment_15` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_shipment_15` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sequence_shipment_16`
--

DROP TABLE IF EXISTS `sequence_shipment_16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sequence_shipment_16` (
  `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence_value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sequence_shipment_16`
--

LOCK TABLES `sequence_shipment_16` WRITE;
/*!40000 ALTER TABLE `sequence_shipment_16` DISABLE KEYS */;
/*!40000 ALTER TABLE `sequence_shipment_16` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `setup_module` VALUES ('Amazon_Core','4.0.4','4.0.4'),('Amazon_Login','4.0.4','4.0.4'),('Amazon_Payment','4.0.4','4.0.4'),('Bss_ForceLogin','1.1.0','1.1.0'),('Dotdigitalgroup_Chat','1.3.0','1.3.0'),('Dotdigitalgroup_Email','4.10.0','4.10.0'),('Dotdigitalgroup_Sms','1.0.0','1.0.0'),('GetJohn_StoreCreator','1.0.0','1.0.0'),('Klarna_Core','6.0.2','6.0.2'),('Klarna_Kp','7.1.0','7.1.0'),('Klarna_KpGraphQl','0.9.0','0.9.0'),('Klarna_Onsitemessaging','1.0.2','1.0.2'),('Klarna_Ordermanagement','6.0.3','6.0.3'),('Magento_ComposerRootUpdatePlugin','0.1.0','0.1.0'),('Magento_GoogleShoppingAds','4.0.1','4.0.1'),('Magento_Securitytxt','1.0.0','1.0.0'),('Paymentsense_Payments','2.4.3','2.4.3'),('PayPal_Braintree','4.0.3','4.0.3'),('Vertex_AddressValidation','100.5.0','100.5.0'),('Yotpo_Yotpo','3.1.3','3.1.3');
...
CREATE TABLE `tax_nexus` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `api_id` int(10) unsigned DEFAULT NULL COMMENT 'API ID',
  `street` varchar(255) DEFAULT NULL COMMENT 'Street',
  `city` varchar(255) DEFAULT NULL COMMENT 'City',
  `country_id` varchar(2) DEFAULT NULL COMMENT 'Country Id',
  `region` varchar(255) DEFAULT NULL COMMENT 'Region',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='TaxJar Nexus Address';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tax_nexus`
--

LOCK TABLES `tax_nexus` WRITE;
/*!40000 ALTER TABLE `tax_nexus` DISABLE KEYS */;
/*!40000 ALTER TABLE `tax_nexus` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tfa_user_config` VALUES (1,2,'[]','0:3:','google');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_60254132a9459.jpeg',0,'frontend',0,'Magento/blank'),(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),(3,1,'Magento/luma','Magento Luma','preview_image_60254132bf3e8.jpeg',0,'frontend',0,'Magento/luma');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='TaxJar Product Tax Codes';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tj_product_tax_categories`
--

LOCK TABLES `tj_product_tax_categories` WRITE;
/*!40000 ALTER TABLE `tj_product_tax_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `tj_product_tax_categories` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `wishlist` VALUES (1,1,0,'e7LcZMiOQKjbcTTxIaOokZTQcWeXv6n7','2021-03-26 07:18:05');
...
-- Dump completed on 2021-03-26  7:19:38
